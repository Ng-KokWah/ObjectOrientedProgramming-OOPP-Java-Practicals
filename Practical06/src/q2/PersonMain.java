...
public class PersonMain {
	...
	public static Lecturer getTopLecturer(ArrayList<Lecturer> lecturerList) {
		Lecturer top = lecturerList.get(0);
	...
	public static void main(String[] args) {
		...
		Lecturer top2 = getTopLecturer(lList);
		System.out.print("Top Lecturer is "+top2.getName());
		System.out.print(" with $"+top2.computeSalary());
	}
